...
5. This folder available locally:
   - `/u01/scripts/agent_fucn_tool/function_tool_demo`
...
```bash
python /u01/scripts/agent_fucn_tool/function_tool_demo/oci_agent_weather_tool.py \
  --location "Chicago" \
...
```bash
python /u01/scripts/agent_fucn_tool/function_tool_demo/genai_weather_client.py \
...
```bash
source /u01/venv/bin/activate
python -m py_compile /u01/scripts/agent_fucn_tool/function_tool_demo/oci_agent_weather_tool.py
python -m py_compile /u01/scripts/agent_fucn_tool/function_tool_demo/genai_weather_client.py
```
