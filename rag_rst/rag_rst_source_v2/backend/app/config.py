...
class Settings:
    app_name: str = os.getenv("APP_NAME", "Code Aster OCI RAG Source V2")
    ...
    oci_auth_mode: str = os.getenv("OCI_AUTH_MODE", "auto").strip().lower()
    ...
    ingestion_chunk_batch_size: int = int(os.getenv("INGESTION_CHUNK_BATCH_SIZE", "256"))
    ingestion_image_batch_size: int = int(os.getenv("INGESTION_IMAGE_BATCH_SIZE", "16"))
    admin_token: str = os.getenv("ADMIN_TOKEN", "")
    chunks_table: str = os.getenv("RAG_CHUNKS_TABLE", "rsv2_chunks")
    images_table: str = os.getenv("RAG_IMAGES_TABLE", "rsv2_images")
    chat_events_table: str = os.getenv("RAG_CHAT_EVENTS_TABLE", "rsv2_chat_events")
