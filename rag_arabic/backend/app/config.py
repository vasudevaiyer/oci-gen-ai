...
class Settings:
    app_name: str = os.getenv("APP_NAME", "AgentStudio")
    data_dir: Path = Path(os.getenv("DATA_DIR", str(DATA_DIR)))
    chunk_table_name: str = os.getenv("CHUNK_TABLE_NAME", "rag_arabic_chunks")
    image_table_name: str = os.getenv("IMAGE_TABLE_NAME", "rag_arabic_images")
    ...
    chunk_overlap_words: int = int(os.getenv("CHUNK_OVERLAP_WORDS", "28"))
