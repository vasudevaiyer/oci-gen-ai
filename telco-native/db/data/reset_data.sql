...
PROMPT =====================================================
PROMPT  Resetting Seer Comms Network Experience Demo Data
PROMPT =====================================================
...
TRUNCATE TABLE telecom_case_entities;
TRUNCATE TABLE telecom_graph_relationships;
TRUNCATE TABLE telecom_experience_cases;
TRUNCATE TABLE telecom_graph_entities;
...
BEGIN
    FOR s IN (
        ...
        EXCEPTION
            WHEN OTHERS THEN
                IF SQLCODE = -32793 THEN
                    DBMS_OUTPUT.PUT_LINE('Skipping system-generated identity sequence: ' || s.sequence_name);
                ELSE
                    RAISE;
                END IF;
        END;
    END LOOP;
    DBMS_OUTPUT.PUT_LINE('Identity sequence reset step complete.');
END;
/
