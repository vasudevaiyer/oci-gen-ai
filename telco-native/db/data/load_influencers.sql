 ...
 * 500 digital advocates across subscriber and social platforms
 */

SET SERVEROUTPUT ON
PROMPT Loading telecom digital advocates...
...
BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Digital advocates loaded: ' || v_count);
END;
/
