 ...
 * Seed data for service demand regions
 *
 * WHY THIS WAS EMPTY:
 ...
 *
 * demand_regions captures geographic network access segments with:
 *   - SDO_GEOMETRY boundary polygon (WGS84 / SRID 4326)
 *   - population, avg_income, network signal density
 *   - service demand index (0-100, Oracle AI-scored)
 *
 * Used by: OML Analytics and Coverage & Capacity Map heat overlays
 *
...
PROMPT Loading service demand regions...
