/*
 * load_customers.sql
 * 2000 synthetic subscribers across US metro areas
 */

SET SERVEROUTPUT ON
PROMPT Loading synthetic subscribers...
...
BEGIN
    ...
    FOR i IN 1..2000 LOOP
        ...
        v_email := LOWER(v_fnames(MOD(i, v_fnames.COUNT) + 1)) || '.' ||
                   ...
                   i || '@synthetic-subscriber.example';
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Synthetic subscribers loaded: ' || v_count);
END;
/
