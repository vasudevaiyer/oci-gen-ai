...
-- ============================================================
-- FULFILLMENT CENTERS (network operations centers / service hubs kept on baseline table name)
-- ============================================================
...
-- ============================================================
-- INVENTORY (telecom service capacity / network supply units at each access center)
-- ============================================================
...
CREATE TABLE orders (
    ...
    social_source_id   NUMBER,         -- FK to social_posts if service order was influenced by a subscriber/network signal
